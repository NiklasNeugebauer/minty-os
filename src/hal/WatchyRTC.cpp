// This is a modified version of the original WatchyRTC.cpp from the Watchy Project
// Link: https://github.com/sqfmi/Watchy
// Modifications have been made for Minty-OS
...
void WatchyRTC::setAlarmNextMinute() {
